  ...
  return _c("layout", [
    _c("div", [
      ...
      _c("p", { staticClass: "text-justify" }, [
        _vm._v(
          "Lorem ipsum dolor sit amet consectetur adipisicing elit. Sapiente magnam, molestias aliquam inventore, perspiciatis sequi dolorem sit nostrum obcaecati facere ullam! Velit delectus labore harum laudantium amet cumque ut assumenda."
        )
      ])
    ])
  ])
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("nav", { staticClass: "bg-red-500 p-5 md:shadow-md sticky" }, [
      ...
      _c(
        "div",
        { staticClass: "items-center flex flex-col items-center mx-5 mt-4" },
        [
      ...
      _c(
        ...
        {
          staticClass:
            "flex justify-end sm:justify-center bg-gray-200 py-10 text-white mt-20"
        },
        [_vm._v("This is our footer")]
      )
    ]
  )
}
